...
def plotConvInDOccLin():
    ...
    # read in stuff
    fileNB1 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB4TS40WPh1236.hdf5", 'r')
    fileNB2 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB6TS40WPh1236.hdf5", 'r')
    fileNB3 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB8TS40WPh1236.hdf5", 'r')
    fileNB4 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB10TS40WPh1236.hdf5", 'r')
    fileNB5 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB12TS40WPh1236.hdf5", 'r')
    ...
    # read in stuff
    fileNT1 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB8TS10WPh1236.hdf5", 'r')
    fileNT2 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB8TS20WPh1236.hdf5", 'r')
    fileNT3 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB8TS40WPh1236.hdf5", 'r')
    fileNT4 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB8TS80WPh1236.hdf5", 'r')
    fileNT5 = h5py.File("../data/tEvol2PhGPH50WP14WD200FD300NB8TS160WPh1236.hdf5", 'r')
